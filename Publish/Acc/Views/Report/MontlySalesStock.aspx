<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MontlySalesStock.aspx.cs" Inherits="IslamTraders_Accounts.Views.Report.MontlySalesStock" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h3>Monthly Sales Stock</h3>
    <table>
        <tr>
