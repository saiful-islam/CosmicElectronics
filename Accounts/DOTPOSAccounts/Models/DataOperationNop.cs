...
{
    public class DataOperationNop
    {
        string strConn = ConfigurationManager.ConnectionStrings["NopConnection"].ConnectionString;
        public DataTable GetDataTable(string _query)
        {
            ...
            _da.SelectCommand.CommandTimeout = 50000;
            _da.Fill(dt);
