<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CategoryWiseProfit.aspx.cs" Inherits="IslamTraders_Accounts.Views.Report.CategoryWiseProfit" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <br/>
    <asp:GridView ID="gvCategoryWiseProfit" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" CssClass="table">
