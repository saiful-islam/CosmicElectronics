<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="OrderDue.aspx.cs" Inherits="IslamTraders_Accounts.Views.Payment.OrderDue" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <br/>
    <h1>Order wise Due</h1>
    <table>
        <tr>
            <td>
